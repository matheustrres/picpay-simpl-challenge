...
describe('BrazilianUtils lib', () => {
	describe('.isValidEmail', () => {
		it('should return false if an invalid value is provided', () => {
			deepStrictEqual(BrazilianUtils.isValidEmail(''), false);
			deepStrictEqual(BrazilianUtils.isValidEmail('john.doe@.com'), false);
			deepStrictEqual(BrazilianUtils.isValidEmail('@gmail.com'), false);
			deepStrictEqual(BrazilianUtils.isValidEmail('.jonh.doe@live'), false);
		});
